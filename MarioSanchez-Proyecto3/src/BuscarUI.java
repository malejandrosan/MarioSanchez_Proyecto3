 ...
 * @author MARIO
 */
public class BuscarUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Búsqueda de Id de una impresora");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
